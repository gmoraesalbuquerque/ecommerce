    ...
    class Category extends Model {
        ...
        public function getProducts($related = true){
            ...
            if ($related === true) {
                ...
                return 
                $sql->select("SELECT * FROM tb_products WHERE idproduct NOT IN(SELECT a.idproduct FROM tb_products a INNER JOIN tb_productscategories b ON a.idproduct = b.idproduct WHERE b.idcategory = :idcategory);", [
